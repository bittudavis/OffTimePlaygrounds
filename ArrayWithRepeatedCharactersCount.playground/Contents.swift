...
class SomeClass {
    ...
    func add(character: String) {
        ...
        guard let _ = dictionary[character] else {
    ...
    func freq(character: String) -> Int {
        let count = dictionary[character] ?? 0
        return count
    }
}

let classInstance = SomeClass.init()
print(classInstance.cList)
print(classInstance.dictionary)
classInstance.add(character: "g")
classInstance.add(character: "e")
classInstance.add(character: "e")
classInstance.add(character: "k")
classInstance.add(character: "s")
print(classInstance.cList)
print(classInstance.freq(character: "y"))
