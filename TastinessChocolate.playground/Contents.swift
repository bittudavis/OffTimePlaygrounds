...
func lastTastyChocolateForIshaanSister(from array: [Int]) -> Int {
    var begin = 0
    ...
    while end > begin {
        if array[begin] > array[end] {
            begin += 1
            remainingCount = array[end]
        } else if array[begin] < array[end] {
            end -= 1
            remainingCount = array[begin]
        } else if array[begin] == array[end] {
            begin += 1
            remainingCount = array[end]
        }
...
print(lastTastyChocolateForIshaanSister(from: [5,3,1,6,9]))
print(lastTastyChocolateForIshaanSister(from: [2,6,4,8,1,6]))
print(lastTastyChocolateForIshaanSister(from: [2,2,2,2]))
